...
const About: React.FC = () => {
  return (
    <main className="bg-about h-full p-20 flex items-center justify-center gap-20" id='about'>
      <div className="">
        <img className='rounded-full shadow-2xl' width="450rem" src="./me.jpg" alt="foto de daniel" />
      </div>
      <div className="max-w-3xl text-justify">
        ...
        <br />
        <p className='text-2xl'>Apaixonado por transformar desejos e sonhos em experiências digitais memoráveis. Acredito que a tecnologia tem o poder único de dar vida a ideias e conectar pessoas de maneiras significativas.</p>
      </div>
    </main>
  );
};
